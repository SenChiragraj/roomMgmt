...
export class EditRoomComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private service: RoomService, private router: Router, private route: ActivatedRoute) {
    this.editForm = this.fb.group({
      name: ['', [Validators.required, Validators.minLength(3)] ],
      floor: ['', [Validators.required, Validators.minLength(1)] ],
      capacity: [0, [Validators.required, Validators.min(1)]],
      lastInspection: [new Date(), [Validators.required]],
